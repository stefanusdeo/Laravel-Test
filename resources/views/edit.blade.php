    ...
    <div>
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-body">
                    <form action="/editDompet" method="POST">
                        @csrf
                        <div class="row">
                            <input name="id" value="{{ $dompet->id }}" hidden>
                            <div class="mb-3 col-sm-6">
                                <label for="exampleInputEmail1" class="form-label">Nama</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" name="nama"
                                    aria-describedby="emailHelp" value="{{ $dompet->nama }}">
                            </div>
                            <div class="mb-3 col-sm-6">
                            ...
                            <div class="mb-3 col-sm-12">
                                ...
                                <textarea type="text" class="form-control" id="deskripsi"
                                    name="deskripsi">{{ $dompet->deskripsi }}</textarea>
                            </div>
